...
rgen=f' {K}[{RED}√{K}] {P}'
wt=f' {K}[{GREEN}?{K}] {P}'
fst=f'{dot}[{H}sathi{M}={H}abir{M}={H}tisha{M}={H}Hossain {M}={H}samim{P}]'
...
def banner():0
  ...
  {H}  ║{P}[{H}•{P}] Facebook  : {H}Hossain  Ahmed             {N}{H}║
    {H}║{P}[{H}•{P}] Whatsapp  : {M}+8801841004250          {N}{H}║
  {H}  ║{P}[{H}•{P}] Github    : {K}github.com/{N}    {H}  ║
...
def mainx():
    ...
    Hossain  = input(f'{wt}Select menu {M}:{H} ')
    if Hossain  in ["1","01"]:
        exit()
    elif Hossain  in ["2","02"]:
        exit()
    elif Hossain  in ["3","03"]:
        cr()
    elif Hossain  in ["4","04"]:
        mainx2()
    elif Hossain  in ["5","05"]:
        sep()
    elif Hossain  in ["6","06"]:
     dupcutter()
    elif Hossain  in ["7","07"]:
     os.system("xdg-open https://www.youtube.com/@btmctips");mainx()
    elif Hossain  in ["8","08"]:
     os.system("xdg-open https://www.facebook.com/profile.php?id=100092174587959");mainx()
    elif Hossain  in ["0","00"]:
     print(f'{gen}{RED}Exited {H}FB-KING {P}Terminal ');os.system("xdg-open https://www.facebook.com/profile.php?id=100092174587959");time.sleep(3);os.system('xdg-open https://www.youtube.com/@btmctips');exit()
    else:
     print(f"{dot}{M}Don't Select Wrong Options ");os.system("https://www.youtube.com/@btmctips");mainx()
def mainx2():
    os.system("clear")
    banner()
    ...
    if Hossain  in ["1","01"]:
     ...
     mainx()
        ...
        print(f"{dot}{M}Don't Select Wrong Options ");os.system("xdg-open https://www.facebook.com/FB.KING.Hossain .NAME.TOH.SONSO?mibextid=ZbWKwL");mainx()
...
def sep():
    ...
    print(led);print(f'{dot}Total File Ids {M}:{H} ' +
          str(len(open(file_name).read().splitlines())));print(led);print(f'{gen}Example {M}:{H} /sdcard/Hossain .txt');print(led)
...
def dupcutter():
    os.system('clear');banner();print(f'{dot}Example   {RED}:{H} /sdcard/Hossain .txt');print(led)
    Error = input(f"{wt}{N}File Name {RED}:{H} ");print(led);print(f'{dot}Example   {RED}:{H} /sdcard/Hossain .txt');print(led)
